    ...
    <div class='col-sm-12'>
        <div class='box'>
            <div class='box-content'>
                ...
                //echo $this->Form->input('animal_id', array("readonly" => "readonly"));
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5 controls">
                        <?php echo $this->Html->image('../../site/upload/album_animal/' . $this->request->data["Animal"]["id"] . '/s_' . $this->request->data["AlbunsAnimal"]["imagem"]); ?>
                    </div>
                </div>
