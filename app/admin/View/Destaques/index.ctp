                        ...
                        <table class='data-table table table-bordered table-striped' style='margin-bottom:0;' >
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center"><?php echo $this->Paginator->sort('ativo'); ?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><?php echo $destaque['Destaque']['ativo'] == 1 ? "<span class=\"label label-success\">Sim</span>" : "<span class=\"label label-danger\">Não</span>"; ?>&nbsp;</td>
                                    <td>
                                        <div class="text-center">
                                        <?php
                                        echo $this->Html->link('<i class=\'icon-pencil\'></i>', array('action' => 'edit', $destaque['Destaque']['id']), array('class' => 'btn btn-warning btn-xs has-tooltip','title'=> 'Editar','data-original-title' => 'Editar','data-placement' => 'top','escape' => false)) . '&nbsp;'; 
