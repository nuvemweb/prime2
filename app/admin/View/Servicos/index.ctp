                        ...
                        <table class='data-table table table-bordered table-striped' style='margin-bottom:0;' >
                            <thead>
                                <tr>
                                    ...
                                    <th width="20%"><?php echo $this->Paginator->sort('slug'); ?></th>
                            ...
                            <tbody>
                                <?php foreach ($servicos as $servico): ?>
                                   <tr>
                                      ...
                                      <td><?php echo h($servico['Servico']['slug']); ?>&nbsp;</td>
                                      <td>
                                          <div class="text-center">
                                            <?php echo $this->Html->link('<i class=\'icon-pencil\'></i> Editar', array('action' => 'edit', $servico['Servico']['id']), array('class' => 'btn btn-warning btn-xs has-tooltip','title'=> 'Editar','data-original-title' => 'Editar','data-placement' => 'top','escape' => false)) . '&nbsp;'; 
