<div class="fundo-footer col-md-12">
	<div class="container">
		...
		<div class="footer-paginas col-md-2 col-xs-6">
			<span>Páginas</span>
			<ul>
				<li><a href="<?php echo $this->request->base;?>">Home</a></li>
				<li><a href="http://www.classificadosprime.com.br/admin/users/cadastrar">Cadastrar</a></li>
				<li><a href="<?php echo $this->request->base; ?>">Chat (em breve)</a></li>
				<li><a href="<?php echo $this->request->base; ?>/galeria">Galeria</a></li>
				<li><a href="<?php echo $this->request->base; ?>/contato">Contato</a></li>
			</ul>
		</div>
