...
<div class="col-md-12 fundo-subpaginas">
	<div class="container">
		<div class="titulo-interna">
			<span class="paginacao">Home / Anúncios / Eletrodomésticos</span>
...
<div class="container">
	<div class="galeria-conteudo col-md-12">
		...
		<?php foreach($Anuncios as $Anuncio):?>
			<?php if($Anuncio['Anuncio']['categoria'] == "eletrodomesticos") {?>
		...
		<div class="galeria-esquerda col-md-4">
			...
			<a href="<?php echo $this->request->base ?>/galeria/view/<?php echo $Anuncio['Anuncio']['id']?>"><p><span><?php echo $Anuncio['Anuncio']['titulo'];?></span> <?php echo $Anuncio['Anuncio']['descricao'];?></p></a>
			</div>
			<?php } ?>
			<?php endforeach;?>
